...
const generateNewCard = (taskData) =>
  ...
  <div class="card">
    ...
    />
    <div class="card-body">
      <h5 class="card-title" contenteditable="false" id="edit">${taskData.taskTitle}</h5>
      <p class="card-text" contenteditable="false" id="edit">
      ${taskData.taskDescription}
      </p>
      <a href="#" class="btn btn-primary" contenteditable="false" id="edit">${taskData.taskType}</a>
    </div>
    <div class="card-footer">
      <button type="button" class="btn btn-outline-primary float-end btn__text__change">
        Open Task
      </button>
    </div>
  </div>
...
//on click pencil
//access task_title, task_type, task_description
//set contenteditable attribute value to true in all these
